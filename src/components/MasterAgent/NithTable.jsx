...
export default function NinthTable({ agentRefs, searchId }) {
  ...
  return (
    <div>
      <h4 className="mt-4 mb-2 text-[21px] md:text-[21px] font-extrabold text-center text-black">
        সাব এডমিন 1 এর অধীনে সুপার এজেন্ট 204 এর অধীনে সর্বমোট মাস্টার এজেন্ট
        আছে 5 জন{" "}
      </h4>
      ...
      <div className="p-4 flex flex-col justify-center items-center">
        <div className="w-full md:w-auto">
          <table className="table-fixed border-collapse border border-gray-300 w-full">
            ...
            <tbody>
              {MasterAgent.slice(160, 165).map((agent, rowIndex) => (
                <tr
                key={agent.id}
