      ...
      <div className="p-4 flex flex-col justify-center items-center">
        <div className="w-full md:w-auto">
          <table className="table-fixed border-collapse border border-gray-300 w-full">
            <thead>
              <tr>
                <th className="border border-gray-400 px-2 md:py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[14%] h-[10%]">
                  ID NO
                </th>
                <th className="border border-gray-400 px-2 md:py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[17%]">
                  AGENT
                </th>
                <th className="border border-gray-400 px-2 md:py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[10%]">
                  APP
                </th>
                <th className="border border-gray-400 px-2 md:py-2 bg-[#fff6f3] text-xs sm:text-sm md:text-base w-[35%]">
                  PHONE NUMBER
                </th>
                <th className="border border-gray-400 px-2 md:py-2 bg-[#fff6f3] sm:text-center text-left text-xs sm:text-sm md:text-base w-[24%]">
                  COMPLAIN
                </th>
              </tr>
            </thead>
            <tbody>
              {MasterAgent.slice(0, 6).map((agent, rowIndex) => (
                <tr
                key={agent.id}
                ...
                >
                  <td className="border border-gray-300 md:px-2 md:py-2 text-[12px] md:text-xl font-extrabold">
                    {agent.id}
                  </td>
                  <td className="border border-gray-300 md:px-2 md:py-2 text-[12px] md:text-xl font-extrabold">
                    {agent.agent}
