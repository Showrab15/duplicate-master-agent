...
export default function SecondTable({ agentRefs, searchId }) {
  ...
  return (
    <div>
      <h3 className="mt-4 mb-2 text-[21px] md:text-[21px] font-extrabold text-center text-black">
        সাব এডমিন 1 এর অধীনে সুপার এজেন্ট 165 এর অধীনে সর্বমোট মাস্টার এজেন্ট
        আছে 14 জন
      </h3>
